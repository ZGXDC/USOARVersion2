...
class rsnaDataset(Dataset): #load in csv file and generate image paths
    #Modify this -- start from example
    #have list of images
    #have canerous and non-canerous
    #build current stack of lists, every epoch --> make method called increase size
    #wrapper for a csv file
...
trainDataset = rsnaDataset(trainImagesPNG, '/mnt/network/sgrieggs/rsna/train_balanced.csv', transform)
...
PATH = "/home/zgxdc/rsnaPaths/resnet50Epoch4.pth"
...
for epoch in range(100): #1000 epochs
    ...
    #save model
    filePath = os.path.join(directoryPath, f'resnet50NewCSVEpoch{epoch+1}.pth')
...
#/home/zgxdc/USOAR/venv/bin/python /home/zgxdc/USOAR/resnet50Workspace.py >log.txt -pipes output into text file
#/home/zgxdc/USOAR/venv/bin/python /home/zgxdc/USOAR/mainWorkspace.py >thousandEpochs.txt
#/home/zgxdc/USOAR/venv/bin/python /home/zgxdc/USOAR/DynamicScaling.py >log.txt
#put epochs in separate folder, save/run evaluation every epoch --run for 1000