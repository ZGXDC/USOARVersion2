...
for epoch in range(5): #1000 epochs
    running_loss = 0.0
    ...
    #save model
    filePath = os.path.join(directoryPath, f'modelEpoch{epoch+1}.pth')
...
#/home/zgxdc/USOAR/venv/bin/python /home/zgxdc/USOAR/mainWorkspace.py >log.txt -pipes output into text file
